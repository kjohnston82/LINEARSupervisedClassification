...
source("src/astro/utils/classification/GenerateRFAndROCCurves.R")
...
for(i in 1:length(classType)){
	...
	performanceCurves = GenerateRFAndROCCurves(
...
rocArrayRF <- rocAucArray;
prArrayRF <- prAucArray;

save(rocArrayRF , prArrayRF , file = "data/performance/individual/RFPerformance.R")

plot(prAucArray, rocAucArray, xlab = "PR-AUC", ylab = "ROC-AUC", 
xlim = c(0,1), ylim = c(0,1), main = "kNN", pch = 1, col = 1);
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[c(1,2,6)], rocAucArray[c(1,2,6)], pch = 16, col = 3)
text(prAucArray[c(1,2,6)], rocAucArray[c(1,2,6)], labels = classType[c(1,2,6)], cex = 0.5, pos = c(2,1,2))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[7:9], rocAucArray[7:9], pch = 16, col = 4)
text(prAucArray[7:9], rocAucArray[7:9], labels = classType[7:9], cex = 0.5, pos = c(2,3,2))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[10:12], rocAucArray[10:12], pch = 16, col = 5)
text(prAucArray[10:12], rocAucArray[10:12], labels = classType[10:12], cex = 0.5, pos = c(1,2,2))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[13:19], rocAucArray[13:19], pch = 16, col = 6)
text(prAucArray[13:19], rocAucArray[13:19], labels = classType[13:19], cex = 0.5, pos = c(1,4,1,1,1,1,1))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[29:32], rocAucArray[29:32], pch = 16, col = 7)
text(prAucArray[29:32], rocAucArray[29:32], labels = classType[29:32], cex = 0.5, pos = c(4,2,1,1))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[c(3,4,5,23,25,26)], rocAucArray[c(3,4,5,23,25,26)], pch = 16, col = 8)
text(prAucArray[c(3,4,5,23,25,26)], rocAucArray[c(3,4,5,23,25,26)], labels = classType[c(3,4,5,23,25,26)], 
cex = 0.5, pos = c(1,1,1,1,1,1))
grid()
...
plot(prAucArray, rocAucArray, xlab = "PR-AUC", ylab = "ROC-AUC", 
xlim = c(0,1), ylim = c(0,1), main = "SVM", pch = 1, col = 1);
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
