...
for(i in 1:length(classType)){
	...
	#featureTmp <- splitForTrainingAndTest(feat.train, tmpTargets , ratio = 0.5)
	...
	ROC.AUC = trapz(tmpFalseRate [2,1:length(alphaCrit)], tmpHitRate [2,1:length(alphaCrit)]);
	PR.AUC = trapz(tmpHitRate [2,1:length(alphaCrit)],tmpPrecisionRate [2,1:length(alphaCrit)]);

	rocAucArray[i] = abs(ROC.AUC)
	prAucArray[i] = abs(PR.AUC)

}
rocArrayMLP <- rocAucArray;
prArrayMLP <- prAucArray;

save(rocArrayMLP, prArrayMLP, file = "data/performance/individual/MLPPerformance.R")
...
col = c(2:8), pch = 16, cex = 0.5, title = "Class Type")
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[c(1,2,6)], rocAucArray[c(1,2,6)], pch = 16, col = 3)
text(prAucArray[c(1,2,6)], rocAucArray[c(1,2,6)], labels = classType[c(1,2,6)], cex = 0.5, pos = c(1,1,1))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[7:9], rocAucArray[7:9], pch = 16, col = 4)
text(prAucArray[7:9], rocAucArray[7:9], labels = classType[7:9], cex = 0.5, pos = c(2,1,1))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[10:12], rocAucArray[10:12], pch = 16, col = 5)
text(prAucArray[10:12], rocAucArray[10:12], labels = classType[10:12], cex = 0.5, pos = c(2,2,1))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[13:19], rocAucArray[13:19], pch = 16, col = 6)
text(prAucArray[13:19], rocAucArray[13:19], labels = classType[13:19], cex = 0.5, 
pos = c(4,4,4,1,1,3,3))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[29:32], rocAucArray[29:32], pch = 16, col = 7)
text(prAucArray[29:32], rocAucArray[29:32], labels = classType[29:32], cex = 0.5, pos = c(4,1,3,1))
grid()
...
lines(alphaCrit ,alphaCrit, col=1, lty = 2)
points(prAucArray[c(3,4,5,23,25,26)], rocAucArray[c(3,4,5,23,25,26)], pch = 16, col = 8)
text(prAucArray[c(3,4,5,23,25,26)], rocAucArray[c(3,4,5,23,25,26)], 
labels = classType[c(3,4,5,23,25,26)], cex = 0.5, pos = c(1,3,1,4,4,4))
grid()
...
legend("bottomright", legend = c("55<", "55 =>"), 
