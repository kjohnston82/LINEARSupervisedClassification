...
rocArrayKNN <- rocAucArray;
prArrayKNN <- prAucArray;

save(rocArrayKNN , prArrayKNN , file = "data/performance/individual/KNNPerformanceIndividual.R")
