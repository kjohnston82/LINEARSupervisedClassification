...
rf.tr = randomForest(x=as.matrix(feat.train),y=class.train,mtry=10,ntree=100)
...
cat("Fitting Random Forest Pulsating\n")
...
cat("Fitting Random Forest Eruptive\n")
...
cat("Fitting Random Forest MultiStar\n")
...
cat("Fitting Random Forest Unknown\n")
