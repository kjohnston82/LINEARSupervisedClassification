...
## Lupton (2005)
## These equations that Robert Lupton derived by matching DR4 photometry to 
## Peter Stetson's published photometry for stars.
...
ColorTransformUgriz2BVR = function(u,g,r,i,z){
